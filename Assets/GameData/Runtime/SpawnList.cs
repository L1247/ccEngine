...
{	
    ...
    public SpawnListData[] dataArray;
    
	public List<SpawnListData> SpawnListDataList;
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new SpawnListData[0];
		SpawnListDataList = new System.Collections.Generic.List<SpawnListData>( dataArray );
    }
